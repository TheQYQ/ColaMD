...
يمكن تنزيل جميع الملفات الثنائية لنظام Linux وmacOS وWindows من [صفحة الإصدارات](https://github.com/TheQYQ/ColaMD/releases/latest). إذا لم يكن الإصدار متاحًا لنظامك، فيرجى فتح [مشكلة](https://github.com/TheQYQ/ColaMD/issues).

## التطوير

إذا أردت بناء ColaMD بنفسك، فراجع [دليل التطوير](../PROJECT_GUIDE.md).

- [دليل التطوير](../PROJECT_GUIDE.md)
