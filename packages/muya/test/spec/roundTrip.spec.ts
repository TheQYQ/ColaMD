...
// Backported from colamd `test/unit/specs/markdown-basic.spec.js`. Each
...
describe('colamd markdown-basic round-trip', () => {
    it.each(fixtures)(
        ...
        ({ file }) => {
            ...
            // strict (and was already non-deterministic in colamd for
