...
// Regression for colamd commit 6293d408 "fix: #572 — cursor placement
// after row/column delete". In colamd's `tableBlockCtrl`, when the user
...
// caret evaporated. colamd's fix routed through `findNextBlockInLocation`,
...
// destructive table edit" contract colamd had.
//
...
function makeFakeTable(rowCount: number, cellCount: number) {
    ...
    return {
        ...
        remove: vi.fn(),
        // The whole-table-removed branch (colamd 6293d408 cover-the-edge
...
describe('table.removeRow — returns surviving cell content for cursor placement (colamd 6293d408)', () => {
...
describe('table.removeColumn — returns surviving cell content for cursor placement (colamd 6293d408)', () => {
