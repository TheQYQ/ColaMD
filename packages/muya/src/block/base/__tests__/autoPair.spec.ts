...
// Regression suite for colamd muya auto-pair commits being migrated as
...
// ── colamd 358fa83d "Update auto pair quote logic" (#2960) ──────────────
...
// ── colamd 3fa8a9ae "no need to auto pair in inline code" (#1423) ───────
...
// ── colamd 4278362f "disable autocompletion in inline math" (#715) ─────
...
// ── colamd 701fb9ae "Append soft-lines on text removal" (#2853) ────────
...
// ── colamd 67e18176 "Enter multiple lines in Chinese" (#1117) ──────────
...
// ── colamd bbea7eca "do not auto-pair after alphanumeric" (#2843) ──────
...
// ── colamd #3573 absorb manually typed closing markdown marker ──────────
