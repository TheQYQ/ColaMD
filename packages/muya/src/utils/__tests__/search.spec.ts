...
// Defensive coverage for the search helpers migrated from colamd.
//
// `buildRegexValue` already lines up with colamd 4c517b16 ("fix: search
...
describe('buildRegexValue — colamd 4c517b16 group expansion', () => {
