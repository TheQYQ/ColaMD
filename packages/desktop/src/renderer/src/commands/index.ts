...
const commands: CommandDescriptor[] = [
  ...
  },
  {
    id: 'docs.user-guide',
    execute: async() => {
      window.electron.shell.openExternal('https://github.com/TheQYQ/ColaMD/docs/basics')
    }
  },
  {
    id: 'docs.markdown-syntax',
    execute: async() => {
      window.electron.shell.openExternal('https://github.com/TheQYQ/ColaMD/docs/markdown-syntax')
    }
  },
